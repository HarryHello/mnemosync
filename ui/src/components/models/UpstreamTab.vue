      ...
      <div v-if="selected" class="config-shell" :key="selected.id">
        <div class="config-header">
          ...
          <div class="config-actions">
            ...
            <el-button size="small" type="danger" plain @click="selected && deleteService(selected)">
              删除
            </el-button>
          </div>
        </div>
        ...
        <section class="provider-section">
          ...
          <el-form label-width="90px" class="settings-form">
            ...
            <el-form-item label="API 格式">
              <el-select v-model="settingForm.api_format" style="width: 100%" @change="dirty = true">
                <el-option label="OpenAI 兼容" value="openai" />
                <el-option label="Anthropic" value="anthropic" />
                <el-option label="OpenAI Responses API" value="responses" />
              </el-select>
              <div class="form-tip">
                OpenAI 兼容适用于大多数服务商; Anthropic 用原生 Claude API; Responses 用于 OpenAI 新版接口。
              </div>
            </el-form-item>
            <el-form-item>
              <el-button
    ...
    <el-dialog v-model="createDialog" title="新增上游服务" width="480px">
      <el-form ref="createRef" :model="createForm" :rules="createRules" label-width="90px">
        <el-form-item label="服务 ID" prop="id">
          <el-input v-model="createForm.id" placeholder="例如: dashscope / openrouter" maxlength="64" />
        </el-form-item>
        <el-form-item label="Base URL" prop="base_url">
          <el-input v-model="createForm.base_url" placeholder="https://your-provider.com/v1" />
        </el-form-item>
        <el-form-item label="API Key" prop="api_key">
          <el-input v-model="createForm.api_key" type="password" show-password placeholder="sk-..." />
        </el-form-item>
